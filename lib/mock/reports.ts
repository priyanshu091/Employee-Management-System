...
export const MOCK_AUDIT: AuditEntry[] = [
  { id: 'au1',  dateTime: '8 Jul 2026, 2:34 PM',  rawDate: '2026-07-08', employeeName: 'Divya Nair',   employeeId: 'EMP-006', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Absent',     newValue: 'Present',     reason: 'Employee was present but app failed to record'             },
  { id: 'au2',  dateTime: '8 Jul 2026, 11:20 AM', rawDate: '2026-07-08', employeeName: 'Rahul Kumar',  employeeId: 'EMP-001', changedBy: 'Arjun Dubey', changeType: 'Check-out time', previousValue: '—',          newValue: '07:12 PM',    reason: 'Employee forgot to check out'                              },
  { id: 'au3',  dateTime: '7 Jul 2026, 4:15 PM',  rawDate: '2026-07-07', employeeName: 'Mohit Jain',   employeeId: 'EMP-003', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Late',       newValue: 'Present',     reason: 'Office start time was adjusted for that day'               },
  { id: 'au4',  dateTime: '5 Jul 2026, 10:05 AM', rawDate: '2026-07-05', employeeName: 'Kavya Pillai', employeeId: 'EMP-008', changedBy: 'Arjun Dubey', changeType: 'Check-in time', previousValue: '10:45 AM',   newValue: '10:05 AM',    reason: 'Employee checked in via alternate device, time was wrong'  },
  { id: 'au5',  dateTime: '4 Jul 2026, 6:50 PM',  rawDate: '2026-07-04', employeeName: 'Sneha Verma',  employeeId: 'EMP-002', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Absent',     newValue: 'WFH',         reason: 'Admin approved WFH request retrospectively'                },
  { id: 'au6',  dateTime: '3 Jul 2026, 3:22 PM',  rawDate: '2026-07-03', employeeName: 'Arjun Mehta',  employeeId: 'EMP-007', changedBy: 'Arjun Dubey', changeType: 'Check-out time', previousValue: '—',          newValue: '07:40 PM',    reason: 'App crashed during checkout, employee reported manually'   },
  { id: 'au7',  dateTime: '2 Jul 2026, 9:30 AM',  rawDate: '2026-07-02', employeeName: 'Rohan Gupta',  employeeId: 'EMP-009', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Absent',     newValue: 'Leave',       reason: 'Leave approved retroactively for medical emergency'        },
  { id: 'au8',  dateTime: '1 Jul 2026, 5:00 PM',  rawDate: '2026-07-01', employeeName: 'Priya Sharma', employeeId: 'EMP-004', changedBy: 'Arjun Dubey', changeType: 'Check-in time', previousValue: '10:00 AM',   newValue: '09:45 AM',    reason: 'Biometric sync delayed, actual arrival was earlier'        },
  { id: 'au9',  dateTime: '28 Jun 2026, 2:10 PM', rawDate: '2026-06-28', employeeName: 'Vijay Reddy',  employeeId: 'EMP-011', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Late',       newValue: 'Present',     reason: 'Power outage caused server time sync issue'                },
  { id: 'au10', dateTime: '25 Jun 2026, 11:45 AM',rawDate: '2026-06-25', employeeName: 'Neha Agarwal', employeeId: 'EMP-010', changedBy: 'Arjun Dubey', changeType: 'Check-out time', previousValue: '05:30 PM',   newValue: '07:00 PM',    reason: 'Employee had meeting extension, checkout updated'          },
  { id: 'au11', dateTime: '22 Jun 2026, 9:00 AM', rawDate: '2026-06-22', employeeName: 'Divya Nair',   employeeId: 'EMP-006', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Present',    newValue: 'Leave',       reason: 'Emergency leave approved same day'                         },
  { id: 'au12', dateTime: '18 Jun 2026, 4:30 PM', rawDate: '2026-06-18', employeeName: 'Mohit Jain',   employeeId: 'EMP-003', changedBy: 'Arjun Dubey', changeType: 'Check-in time', previousValue: '10:40 AM',   newValue: '10:05 AM',    reason: 'GPS glitch recorded wrong time'                            },
  { id: 'au13', dateTime: '15 Jun 2026, 3:00 PM', rawDate: '2026-06-15', employeeName: 'Amit Khanna',  employeeId: 'EMP-005', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Absent',     newValue: 'WFH',         reason: 'WFH request was submitted but not auto-approved'           },
  { id: 'au14', dateTime: '10 Jun 2026, 10:15 AM',rawDate: '2026-06-10', employeeName: 'Kavya Pillai', employeeId: 'EMP-008', changedBy: 'Arjun Dubey', changeType: 'Check-out time', previousValue: '06:00 PM',   newValue: '07:15 PM',    reason: 'Client call overran, employee reported correct time'       },
  { id: 'au15', dateTime: '5 Jun 2026, 5:45 PM',  rawDate: '2026-06-05', employeeName: 'Rahul Kumar',  employeeId: 'EMP-001', changedBy: 'Arjun Dubey', changeType: 'Status',        previousValue: 'Late',       newValue: 'Present',     reason: 'Correction request approved — traffic verified'            },
]
